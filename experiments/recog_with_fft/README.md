...
Compared to [previous](https://github.com/usadellab/prot-fin/blob/00571686e669166273509510169edde9f620ecf5/experiments/recog_with_fft/results/runtimes_createdb.csv) results, the database sizes are way lower and mostly below size of input fasta file. There seems to be a slight difference in average count of top scored matches (Average_Hits).
