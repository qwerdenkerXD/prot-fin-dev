# Recognition with Fast Fourier Transformation <br> v0.3-exp-peak_selection
...
python3 summary.py ../results/_v0.3-exp-peak_selection/*.summary.csv > ../results/summary.csv
```
...
Comparing the results with the peak selection by local maxima, as done in [v0.3-exp-stft_params](https://github.com/usadellab/prot-fin/tree/85d930fecefa6052a3d5ee49a921d9fa97432d39/experiments/recog_with_fft/results), the F1 Score has been slightly improved by the sorted selection, but not really significantly, as the difference is below 0.04. When looking at the computation time, this is a bad tradeoff.
